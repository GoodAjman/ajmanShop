...
import com.ajman.dao.*;
import com.ajman.pojo.*;
import com.ajman.service.IOrderService;
import com.ajman.utils.BigDecimalUtil;
import com.ajman.utils.DateTimeUtil;
import com.ajman.utils.FTPUtil;
import com.ajman.utils.PropertiesUtil;
import com.ajman.vo.OrderItemVo;
import com.ajman.vo.OrderProductVo;
import com.ajman.vo.OrderVo;
import com.ajman.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("小柯商城扫码支付，订单号：").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallBack(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByErrorMessage("非小柯商城的订单,回调忽略");
        }
    ...
    public ServerResponse<String> delete(Integer userId, Long orderNo) {
        ...
        Order updateOrder = new Order();
        updateOrder.setId(order.getId());
        updateOrder.setStatus(Const.OrderStatusEnum.ORDER_DELETE.getCode());
        int row = orderMapper.updateByPrimaryKeySelective(updateOrder);
        if (row > 0) {
            return ServerResponse.createBySuccess();
        }
...
//        pageResult.setList(orderVoList);
    ...
    public ServerResponse<String> manageSendGoods(Long orderNo) {
        ...
        return ServerResponse.createByErrorMessage("订单不存在或者未付款");
    }
