...
import com.ajman.vo.ProductListVo;
    ...
    public ServerResponse saveOrUpdateProduct(Product product) {
        ...
        if (product != null) {
            ...
            if (StringUtils.isNotBlank(product.getSubImages())) {
                String[] subImageArray = product.getSubImages().split(",");//从子图列表中获取第一个个元素作为主图
        ...
        return ServerResponse.createBySuccessMessage("新增或者更新产品参数不正确");
    }
    ...
    public ServerResponse<PageInfo> getProductByKeywordCategory(String keyword, Integer categoryId, int pageNum, int pageSize, String orderBy) {
        ...
        if (StringUtils.isNotBlank(orderBy)) {
            if (Const.ProductListOrderBy.PRICE_ASC_DESC.contains(orderBy)) {
                String[] orderByAArray = orderBy.split("_");
                PageHelper.orderBy(orderByAArray[0] + " " + orderByAArray[1]);
            }
        }
